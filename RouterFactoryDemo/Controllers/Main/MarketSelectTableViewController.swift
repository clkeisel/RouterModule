//
//  MarketSelectTableViewController.swift
//  RouterFactoryDemo
//
...
class MarketSelectTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        markets.append("Germany")
        markets.append("China")
        markets.append("North America")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = markets[indexPath.row]
